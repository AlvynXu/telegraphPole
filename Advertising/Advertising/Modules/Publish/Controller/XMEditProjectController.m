...
#import "XMEditProjectController.h"
...
@interface XMEditProjectController ()<JXMovableCellTableViewDataSource, JXMovableCellTableViewDelegate, UINavigationControllerDelegate,UIImagePickerControllerDelegate, TZImagePickerControllerDelegate>
...
@implementation XMEditProjectController
...
- (void)handPublishAction
{
    ...
    // 发送信息
    self.baseInfoRequest.pId = -1992;  // 默认不传值
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (itemModel.type == 1) {
        RAC(itemModel, content) = [tableViewCell.contentTxt.rac_textSignal takeUntil:tableViewCell.rac_prepareForReuseSignal];
    }
