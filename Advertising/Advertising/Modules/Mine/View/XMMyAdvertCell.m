...
- (void)setItemModel:(XMAdvertItemModel *)itemModel
{
    _itemModel = itemModel;
    self.titleLbl.text = itemModel.desc;
    self.statusLbl.text = itemModel.statusStr;
    self.statusLbl.textColor = itemModel.statusColor;
}
